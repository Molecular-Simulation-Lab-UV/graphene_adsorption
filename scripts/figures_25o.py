...
# Path to csv file
table = "../data/tables/Free_Energy_Decomposition_25o.csv"
#table = "/home/mbarria/donelias/AA_GO0US/tables/2021_08_28/Table1.csv"
#output
output = "../figures"
imagename = "Differences_by_names_and_weight_25o"
# separate figures?
SEPARATE = False
...
axs[0, 0].set_yticklabels(["-5", "0", "5", "10"], fontsize=13)
axs[0, 0].set_yticks([-5, 0, 5, 10])

axs[1, 0].set_ylabel("$\Delta A_{ads}~[kJ \cdot mol^{-1}]$", fontsize=13)
axs[1, 0].set_yticklabels(["-1", "0", "1", "2", "3", "4", "5", "6"], fontsize=13)
axs[1, 0].set_yticks([-1, 0, 1, 2, 3, 4, 5, 6])

axs[0, 1].set_ylabel("$\Delta E_{ads}~[kJ \cdot mol^{-1}]$", fontsize=13)
axs[0, 1].set_title("Adsorption Energy", fontsize=15)
axs[0, 1].set_yticklabels(["-40", "-30", "-20", "-10", "0", "10", "20", "30", "40", "50"], fontsize=13)
axs[0, 1].set_yticks([-40, -30, -20, -10, 0, 10, 20, 30, 40, 50])

axs[1, 1].set_ylabel("$\Delta E_{ads}~[kJ \cdot mol^{-1}]$", fontsize=13)
axs[1, 1].set_yticklabels(["-5", "0", "5", "10", "15", "20", "25"], fontsize=13)
axs[1, 1].set_yticks([-5, 0, 5, 10, 15, 20, 25])

axs[0, 2].set_ylabel("$T \Delta S_{ads}~[kJ \cdot mol^{-1}]$", fontsize=13)
axs[0, 2].set_title("Adsorption Entropy", fontsize=15)
axs[0, 2].set_yticklabels(["-40", "-30", "-20", "-10", "0", "10", "20", "30", "40", "50"], fontsize=13)
axs[0, 2].set_yticks([-40, -30, -20, -10, 0, 10, 20, 30, 40, 50])

axs[1, 2].set_ylabel("$T \Delta S_{ads}~[kJ \cdot mol^{-1}]$", fontsize=13)
axs[1, 2].set_yticklabels(["-5", "0", "5", "10", "15", "20", "25"], fontsize=13)
axs[1, 2].set_yticks([-5, 0, 5, 10, 15, 20, 25])
# Formats
