...
fig, axs = plt.subplots(figsize=(14, 7), ncols=3, nrows=3)

counter = 0

sorted_files = sorted(files, key=lambda x: type_dict[x.split("/")[-1][:-8]])


for file in sorted_files:
    aminoacid = file.split("/")[-1][:-8]
