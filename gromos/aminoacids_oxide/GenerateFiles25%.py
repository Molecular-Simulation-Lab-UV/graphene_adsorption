...
genbox = ['4.694700000', '4.865000000', '5.000000000']
# Directories
prepDir = os.getcwd() + '/Prep25US/'
frameoutDir = os.getcwd() + '/FRAMEOUTS/'
templateDir = os.getcwd() + '/Templates/'
outputDir = os.getcwd() + '/Simulation25US/'
...
if __name__ == '__main__':
    with open('Lista.csv', newline='') as csvfile:
        ...
        for row in file:
            ...
            if name not in ['Arginine_H+', 'Asparagine', 'Glutamic_Acid', 'Isoleucine', 'Phenylalanine']:
                continue
